    ...
    function P(e, t) {
      ...
      return (
        e.split(",").forEach(function (e) {
          ...
          switch (t.charAt(0)) {
            case ".":
              l.object(n) && l.string(n.class) && (n.class += " " + s),
                (i.class = s);
              break;
            case "#":
              i.id = t.replace("#", "");
    ...
    var oe = {
      ...
      createButton: function (e, t) {
        ...
        return (
          a
            ? (i.appendChild(
                oe.createIcon.call(this, u, { class: "icon--pressed" })
              ),
              i.appendChild(
                oe.createIcon.call(this, r, { class: "icon--not-pressed" })
              ),
              i.appendChild(
                oe.createLabel.call(this, c, { class: "label--pressed" })
              ),
              i.appendChild(
                oe.createLabel.call(this, o, { class: "label--not-pressed" })
              ))
          ...
          k(i, n),
          "play" === s
            ? (l.array(this.elements.buttons[s]) ||
      ...
      createRange: function (e, t) {
        ...
        return (
          (this.elements.inputs[e] = i), oe.updateRangeFill.call(this, i), i
        );
      },
          ...
          this.listeners.bind(
            ...
            function (e) {
              if (!l.keyboardEvent(e) || 32 === e.which) {
                switch (
                  (e.preventDefault(), e.stopPropagation(), (h.checked = !0), s)
                ) {
                  case "language":
                ...
                (i = this.currentTime),
                  ...
                  (s =
                    0 === i || 0 === n || Number.isNaN(i) || Number.isNaN(n)
                      ...
                      : ((i / n) * 100).toFixed(2)),
                  "timeupdate" === e.type &&
                    oe.setRange.call(this, this.elements.inputs.seek, s);
                break;
              case "playing":
              case "progress":
                !(function (e, i) {
        ...
        if (l.element(t) && "range" === t.getAttribute("type")) {
          if (L(t, this.config.selectors.inputs.seek)) {
            ...
            t.setAttribute("aria-valuenow", a),
              t.setAttribute("aria-valuetext", a.toFixed(1) + "%");
      ...
      durationUpdate: function () {
        if (
          ...
          if (this.duration >= Math.pow(2, 32))
            return (
              S(this.elements.display.currentTime, !0),
              void S(this.elements.progress, !0)
            );
          l.element(this.elements.inputs.seek) &&
        ...
        if ("captions" === e) s = this.currentTrack;
          ...
          if (
            ...
            return void this.debug.warn(
              "Unsupported value of '" + s + "' for " + e
            );
          if (!this.config[e].options.includes(s))
            return void this.debug.warn(
              "Disabled value of '" + s + "' for " + e
            );
        }
        if (
          (l.element(a) || (a = n && n.querySelector('[role="menu"]')),
          l.element(a))
        ) {
      ...
      setQualityMenu: function (e) {
        ...
        if (l.element(this.elements.settings.panels.quality)) {
          ...
          var n =
            !l.empty(this.options.quality) && this.options.quality.length > 1;
          if (
            (oe.toggleMenuButton.call(this, "quality", n),
            E(i),
      ...
      setCaptionsMenu: function () {
        ...
        if (l.element(this.elements.settings.panels.captions)) {
          var t =
            ...
            n = Boolean(i.length);
          if (
            (oe.toggleMenuButton.call(this, "captions", n),
            E(t),
            oe.checkMenu.call(this),
            n)
          ) {
            var s = i.map(function (i, n) {
              return {
                ...
                badge:
                  i.language &&
                  oe.createBadge.call(e, i.language.toUpperCase()),
                list: t,
                type: "language",
              };
            });
      ...
      create: function (e) {
        ...
        if (
          ...
          if (
            (n.appendChild(
              oe.createRange.call(this, "seek", { id: "plyr-seek-" + e.id })
            ),
        ...
        return (
          ...
          this.config.controls.includes("play-large") &&
            this.elements.container.appendChild(
              oe.createButton.call(this, "play-large")
            ),
          (this.elements.controls = i),
          this.isHTML5 &&
            oe.setQualityMenu.call(this, U.getQualityOptions.call(this)),
      ...
      inject: function () {
        ...
        if (
          ...
          o[l.element(i) ? "insertAdjacentElement" : "insertAdjacentHTML"](
            "afterbegin",
            i
          ),
          ...
          Object.values(this.elements.buttons)
            .filter(Boolean)
            .forEach(function (e) {
              l.array(e) || l.nodeList(e)
                ? Array.from(e).filter(Boolean).forEach(r)
                : r(e);
            });
        }
        if (
          (window.navigator.userAgent.includes("Edge") && B(o),
          ...
          Array.from(p).forEach(function (t) {
            M(t, e.config.classNames.hidden, !1),
              M(t, e.config.classNames.tooltip, !0);
          });
        }
      },
    };
              ...
              if (
                (l.element(this.elements.captions) ||
                  ((this.elements.captions = w(
                    "div",
                    P(this.config.selectors.captions)
                  )),
            ...
            if (s !== i) {
              if (
                ...
                return (
                  ...
                  void ce.set.call(this, a.indexOf(o))
                );
              }
    ...
    var be = {
        ...
        build: function () {
          ...
          l.element(this.elements.controls) ||
            (oe.inject.call(this), this.listeners.controls()),
            ...
            this.poster &&
              be.setPoster.call(this, this.poster, !1).catch(function () {}),
        ...
        checkPlaying: function (e) {
          ...
          M(
            ...
            (l.event(e) && "timeupdate" === e.type) ||
              be.toggleControls.call(this);
        },
                ...
                if (
                  ...
                  if (s) {
                    ...
                    if (l.element(o)) {
                      ...
                      if (32 === e.which && L(o, 'button, [role^="menuitem"]'))
                        return;
                    }
                    switch (
                      ([
              ...
              value: function () {
                ...
                d.call(e, e.media, n, function (i) {
                  ...
                  "error" === i.type && (s = e.media.error),
                    f.call(e, t.container, i.type, !0, s);
                });
              },
            },
            {
              ...
              value: function (e, t, i) {
                var n = this.player,
                  ...
                  a = !0;
                l.function(s) && (a = s.call(n, e)),
                  a && l.function(t) && t.call(n, e);
              },
            },
            {
              key: "bind",
            ...
            },
            {
              ...
              value: function () {
                ...
                this.bind(
                  ...
                  V.isWebkit &&
                    Array.from(x.call(t, 'input[type="range"]')).forEach(
                      function (i) {
                  ...
                  this.bind(i.controls, "focusin focusout", function (i) {
                    var n = t.config,
                      ...
                      o = "focusin" === i.type;
                    if (
                      (M(s.controls, n.classNames.noTransition, o),
                      be.toggleControls.call(t, o),
                      o)
                    ) {
                      setTimeout(function () {
      ...
      ready: function () {
        ...
        t.embed
          ...
          t.embed.on("timeupdate", function (e) {
            (t.media.seeking = !1),
              (u = e.seconds),
              f.call(t, t.media, "timeupdate");
          }),
          t.embed.on("progress", function (e) {
            (t.media.buffered = e.percent),
              f.call(t, t.media, "progress"),
              1 === parseInt(e.percent, 10) &&
                f.call(t, t.media, "canplaythrough"),
              t.embed.getDuration().then(function (e) {
                e !== t.media.duration &&
                  ((t.media.duration = e),
                  f.call(t, t.media, "durationchange"));
              });
          }),
      ...
      Me = {
        ...
        getTitle: function (e) {
          ...
          if (l.function(this.embed.getVideoData)) {
            ...
            if (l.empty(i))
              return (this.config.title = i), void be.setTitle.call(this);
          }
        ...
        ready: function () {
          ...
          if (l.empty(t) || !t.startsWith("youtube-")) {
            ...
            var r = function (e) {
              return (
                "https://img.youtube.com/vi/" + s + "/" + e + "default.jpg"
              );
            };
            ve(r("maxres"), 121)
              .catch(function () {
        ...
        return (
          g(e, [
            ...
            },
            {
              ...
              value: function (e, t) {
                return (
                  l.array(this.events[e]) || (this.events[e] = []),
              ...
              this.destroy.call(
                ...
                function () {
                  (t.options.quality = []),
                    A(t.media),
                    (t.media = null),
                    l.element(t.elements.container) &&
            ...
            if (this.media.plyr) this.debug.warn("Target already setup");
              ...
              if (F.check().api) {
                ...
                switch (a) {
                  case "div":
                    if (
                      ((o = this.media.querySelector("iframe")), l.element(o))
                    ) {
                      if (
                        ...
                        var c = ["1", "true"];
                        c.includes(r.searchParams.get("autoplay")) &&
                          (this.config.autoplay = !0),
                          c.includes(r.searchParams.get("loop")) &&
                    ...
                    if (
                      ...
                      !Object.keys(de).includes(this.provider)
                    )
          ...
          g(
            ...
            [
              ...
              },
              {
                ...
                value: function (e) {
                  this.currentTime =
                    this.currentTime - (l.number(e) ? e : this.config.seekTime);
                },
              },
              {
                key: "forward",
